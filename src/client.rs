...
use crate::{error, models, certificates, cryptography, invoice, qr, utils};
...
pub struct Client {
    ...
    sleep_time: u64,
    max_attempts: i32,
    pub(crate) public_certificates: RefCell<Option<Vec<models::PemCertificateInfo>>>,
}
...
impl Client {
    ...
    ) -> Result<models::TokenPair, error::ErrorResponse> {
    ...
    pub async fn refresh_access_token(
    ...
    ) -> Result<models::TokenInfo, error::ErrorResponse> {
        ...
        let response = reqwest_client
            ...
            .send()
            .await;
        match utils::handle_response::<models::RefreshTokenResponse, error::ErrorResponse>(response).await{
    ...
    pub async fn query_invoice_metadata(
    ...
    ) -> Result<invoice::PagedInvoiceResponse, error::ErrorResponse> {
        ...
        utils::handle_response::<invoice::PagedInvoiceResponse, error::ApiErrorResponse>(response).await
    }
    ...
    async fn submit_ksef_token_auth_request(
    ...
    ) -> Result<models::SignatureResponse, error::ErrorResponse> {
        ...
        let response = reqwest_client
            ...
            .send()
            .await;
        utils::handle_response::<models::SignatureResponse, error::ApiErrorResponse>(response).await
    }
    ...
    async fn get_auth_status(
    ...
    ) -> Result<models::AuthStatus, error::ErrorResponse> {
        ...
        utils::handle_response::<models::AuthStatus, error::ErrorResponse>(response).await
    }
    ...
    async fn start_export_invoices(
        ...
        access_token: &String,
    ) -> Result<invoice::OperationResponse, error::ErrorResponse> {
        ...
        utils::handle_response::<invoice::OperationResponse, error::ApiErrorResponse>(response).await
    }
    ...
    async fn get_export_invoice_status(
        ...
        access_token: &String,
    ) -> Result<invoice::ExportInvoiceStatusResponse, error::ErrorResponse> {
        ...
        utils::handle_response::<invoice::ExportInvoiceStatusResponse, error::ErrorResponse>(response).await
    }
    ...
    pub async fn export_invoice(
        ...
        access_token: &String,
    ) -> Result<invoice::ExportInvoiceResult, error::ErrorResponse> {
    ...
    pub async fn open_online_session(
    ...
    ) -> Result<models::OpenOnlineSessionResponse, error::ErrorResponse> {
        ...
        utils::handle_response::<models::OpenOnlineSessionResponse, error::ErrorResponse>(response).await
    }
    ...
    pub async fn send_invoice(
        ...
        utils::handle_response::<invoice::OperationResponse, error::ErrorResponse>(response).await
    }
    ...
    async fn get_session_status(
        ...
        reference_number: &String,
        access_token: &String,
    ) -> Result<models::SessionStatusResponse, error::ErrorResponse> {
        ...
        utils::handle_response::<models::SessionStatusResponse, error::ErrorResponse>(response).await
    }
    ...
    pub async fn open_batch_session(
        ...
        access_token: &String,
    ) -> Result<models::OpenBatchSessionResponse, error::ErrorResponse> {
        ...
        utils::handle_response::<models::OpenBatchSessionResponse, error::ErrorResponse>(response).await
    }
